...
BEGIN
  ...
  VALUES (jorge_id, '00000000-0000-0000-0000-000000000000', 'jorge@example.com', hashed_pw, NOW(), '{"provider":"email","providers":["email"]}', '{"full_name":"Jorge","role":"manager"}', 'authenticated', 'authenticated', NOW(), NOW(), '', '', '', '', '', '', '', '');
  
  -- Carla (Employee)
  INSERT INTO auth.users (id, instance_id, email, encrypted_password, email_confirmed_at, raw_app_meta_data, raw_user_meta_data, role, aud, created_at, updated_at, confirmation_token, recovery_token, email_change, email_change_token_new, email_change_token_current, phone_change, phone_change_token, reauthentication_token)
  VALUES (carla_id, '00000000-0000-0000-0000-000000000000', 'carla@example.com', hashed_pw, NOW(), '{"provider":"email","providers":["email"]}', '{"full_name":"Carla","role":"employee"}', 'authenticated', 'authenticated', NOW(), NOW(), '', '', '', '', '', '', '', '');

  -- Aidel
  INSERT INTO auth.users (id, instance_id, email, encrypted_password, email_confirmed_at, raw_app_meta_data, raw_user_meta_data, role, aud, created_at, updated_at, confirmation_token, recovery_token, email_change, email_change_token_new, email_change_token_current, phone_change, phone_change_token, reauthentication_token)
  VALUES (aidel_id, '00000000-0000-0000-0000-000000000000', 'aidel@example.com', hashed_pw, NOW(), '{"provider":"email","providers":["email"]}', '{"full_name":"Aidel","role":"employee"}', 'authenticated', 'authenticated', NOW(), NOW(), '', '', '', '', '', '', '', '');

  -- Amanda
  INSERT INTO auth.users (id, instance_id, email, encrypted_password, email_confirmed_at, raw_app_meta_data, raw_user_meta_data, role, aud, created_at, updated_at, confirmation_token, recovery_token, email_change, email_change_token_new, email_change_token_current, phone_change, phone_change_token, reauthentication_token)
  VALUES (amanda_id, '00000000-0000-0000-0000-000000000000', 'amanda@example.com', hashed_pw, NOW(), '{"provider":"email","providers":["email"]}', '{"full_name":"Amanda","role":"employee"}', 'authenticated', 'authenticated', NOW(), NOW(), '', '', '', '', '', '', '', '');

  -- Marta
  INSERT INTO auth.users (id, instance_id, email, encrypted_password, email_confirmed_at, raw_app_meta_data, raw_user_meta_data, role, aud, created_at, updated_at, confirmation_token, recovery_token, email_change, email_change_token_new, email_change_token_current, phone_change, phone_change_token, reauthentication_token)
  VALUES (marta_id, '00000000-0000-0000-0000-000000000000', 'marta@example.com', hashed_pw, NOW(), '{"provider":"email","providers":["email"]}', '{"full_name":"Marta","role":"employee"}', 'authenticated', 'authenticated', NOW(), NOW(), '', '', '', '', '', '', '', '');

  -- Luisa
  INSERT INTO auth.users (id, instance_id, email, encrypted_password, email_confirmed_at, raw_app_meta_data, raw_user_meta_data, role, aud, created_at, updated_at, confirmation_token, recovery_token, email_change, email_change_token_new, email_change_token_current, phone_change, phone_change_token, reauthentication_token)
  VALUES (luisa_id, '00000000-0000-0000-0000-000000000000', 'luisa@example.com', hashed_pw, NOW(), '{"provider":"email","providers":["email"]}', '{"full_name":"Luisa","role":"employee"}', 'authenticated', 'authenticated', NOW(), NOW(), '', '', '', '', '', '', '', '');
