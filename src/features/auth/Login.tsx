  ...
  return (
    <div className="w-full max-w-md p-8 glass-panel rounded-2xl shadow-2xl border border-slate-800">
      <div className="text-center mb-8">
        <h1 className="text-3xl font-extrabold text-white tracking-tight mb-2">Spredsheep</h1>
        <p className="text-sm text-slate-400">Employee scheduling for small teams</p>
      </div>
        ...
        <div>
          ...
          <div className="relative">
            ...
            <input
              ...
              placeholder="e.g. jorge@example.com"
              value={email}
